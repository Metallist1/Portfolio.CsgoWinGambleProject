...
<head>
    <meta charset="utf-8">
    <title>CSGOWIN.GG Deposit</title>
</head>
...
<body>
    <div class="boxas">
        ...
        <script src="/gambleproject/js/offer.js"></script>
            ...
            <nav class="midNav">
                <div class="head">
                    ...
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="/gambleproject/withdraw.php">WITHDRAW</a>
                        </li>
                        <li>
                            <a class="activegame">DEPOSIT</a>
                        </li>
                        <li class="right">
        ...
        <div class="main">
            <div class="containboth">
                <div class="TopWD">
                    <div class="Withdrawtext">Deposit</div>
                </div>
                        ...
                        <div class="top">
                            <div class="withdrawButton" id="trade">
                                <div class="WithdrawtxtIngeneral" id="trade">
                                    <div class="Withdrawbuttontxt" id="trade">Deposit Items</div>
                                    <div class="WithdrawBtxt" id="trade">
                                        ...
                                        <div id="availabelcoins" class="tradeclick">| Will be available :
