...
<head>
    <meta charset="utf-8">
    <title>CSGOWIN.GG Withdraw</title>
</head>
...
<body>
    <div class="boxas">
        ...
        <script src="/gambleproject/js/withdraw.js"></script>
        ...
        <header>
            <nav class="midNav">
                <div class="head">
                    ...
                    <ul class="navigation">
                        <li>
                            <a href="/gambleproject/index.php">ROULETTE</a>
                        </li>
                        <!-- <li><a>COINFLIP</a></li><li><a>SWAPPER</a></li><li><a>DICES</a></li>-->
                        <li>
                            <a class="activegame">WITHDRAW</a>
                        </li>
                        <li>
                            <a href="/gambleproject/deposit.php">DEPOSIT</a>
                        </li>
                        <li class="right">
        ...
        <!-- Main body-->
        <div class="main">
            <div class="containboth">
                <div class="TopWD">
                    <div class="Withdrawtext">Withdraw</div>
                </div>
                <div class="contain" id="containuser">
                    <div class="box">
                        <div class="top flexable">
                            ...
                            <div class="otherrow">
                                <input type="text" id="ItemsInput" onkeyup="search('bot')" placeholder="Search item by name">
                                <div class="right" id="dropingdown">
                                    <div class="dropdownOpen sorter">Sort by</div>
                                    <div id="SortB" class="dropdown-content">
                                        <a onclick="sort(1)">Highest price first</a>
                                        <a onclick="sort(0)">Lowest price first</a>
                                    </div>
                                </div>
                            </div>
                            <div id="bots" class="botwindow">
                                <div class="bot nonselect">Choose bot</div>
                                <div class="bot botactive" id="1" onclick="loadbot(1)">#1</div>
                                <div class="bot" id="2" onclick="loadbot(2)">#2</div>
                                <div class="bot" id="3" onclick="loadbot(3)">#3</div>
                            </div>
                        </div>
                    ...
                    <div class="box">
                        <div class="top">
                            <div class="withdrawButton" id="trade">
                                <div class="WithdrawtxtIngeneral" id="trade">
                                    <div class="Withdrawbuttontxt" id="trade">Withdraw Items</div>
                                    <div class="WithdrawBtxt" id="trade">
                                        <div id="userprice" class="tradeclick">
                                            <div class="userpriceinside" id="trade">0</div> coins </div>
                                        <div id="useridentification" class="tradeclick" >Balance :
                                            <div class='useridentificationCLASS' id="trade" >0</div> |</div>
                                        <div id="availabelcoins" class="tradeclick">| Available :
                                            <div class="userpriceinsid" id="trade" >0</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id="Proccess" class="modal">
    <div class="modal-content">
        <div class="modal-inner">Your trade is being processed , please wait.</div>
    </div>
</div>
        ...
        <div class="modal-inner taballign">
            ...
            <div class="FAQmainbody">
                ...
                <div class="paragrafff">
                    ...
                    <div class="Point">1. Click Deposit on the navigation bar. </div>
